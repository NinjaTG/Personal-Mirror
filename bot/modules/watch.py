...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\n<b>Example</b>:\n<code>/{BotCommands.WatchCommand} <code>https://youtu.be/Pk_TthHfLeE 720 |MIRROR ZONE</code>\n\n"
        msg += "<b>This file will be downloaded in 720p quality and it's name will be <b>MIRROR ZONE</b>"
